package com.ztc.testcenter.question.gre.service;

import com.ztc.testcenter.question.gre.repository.*;
...
public class QuestionService {
    ...
    public <T extends Question> Page<T> findAllQuestions(QuestionSpecification<T> specification, Pageable pageable, Class<T> type) {
        return findSpecificationExecuter(specification, type).findAll(specification, pageable);
    }
    ...
    private <T extends Question> JpaSpecificationExecutor<T> findSpecificationExecuter(QuestionSpecification<T> specification, Class<T> type) {
