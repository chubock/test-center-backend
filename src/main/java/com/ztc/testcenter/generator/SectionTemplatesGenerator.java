...
public class SectionTemplatesGenerator {
    ...
    public void createMediumVerbal1SectionTemplate() {
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(1, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL1));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(2, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL2));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(3, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL3));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(4, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL4));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(5, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL3));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(6, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL4));
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(7, QuestionType.GRE_READING_COMPREHENSION_MEDIUM, DifficultyLevel.LEVEL3, questionTemplate));
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT-MEDIUM-1L3");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(11, QuestionType.GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT, DifficultyLevel.LEVEL3, questionTemplate));
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_SHORT-MEDIUM-1L3-1L5");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(12, QuestionType.GRE_READING_COMPREHENSION_SHORT, DifficultyLevel.LEVEL4, questionTemplate));
        ...
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_SHORT-MEDIUM-1L3-1L5");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(18, QuestionType.GRE_READING_COMPREHENSION_SHORT, DifficultyLevel.LEVEL4, questionTemplate));
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT-MEDIUM-1L3");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(20, QuestionType.GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT, DifficultyLevel.LEVEL3, questionTemplate));
    ...
    public void createMediumQuantitative1SectionTemplate() {
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(17, QuestionType.GRE_NUMERIC_FRACTION, DifficultyLevel.LEVEL3));
    ...
    public void createEasyVerbal2SectionTemplate() {
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(1, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL1));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(2, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL2));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(3, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL2));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(4, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL2));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(5, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL3));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(6, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL3));
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(12, QuestionType.GRE_READING_COMPREHENSION_LONG, DifficultyLevel.LEVEL2, questionTemplate));
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(20, QuestionType.GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT, DifficultyLevel.LEVEL2, questionTemplate));
        repository.save(sectionTemplate);
    }
    ...
    public void createEasyQuantitative2SectionTemplate() {
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(17, QuestionType.GRE_NUMERIC_FRACTION, DifficultyLevel.LEVEL4));
    ...
    public void createHardVerbal2SectionTemplate() {
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(1, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL1));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(2, QuestionType.GRE_TEXT_COMPLETION_ONE_BLANK, DifficultyLevel.LEVEL4));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(3, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL4));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(4, QuestionType.GRE_TEXT_COMPLETION_TWO_BLANK, DifficultyLevel.LEVEL5));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(5, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL5));
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(6, QuestionType.GRE_TEXT_COMPLETION_THREE_BLANK, DifficultyLevel.LEVEL5));
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(7, QuestionType.GRE_READING_COMPREHENSION_MEDIUM, DifficultyLevel.LEVEL4, questionTemplate));
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT-HARD-1L5");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(11, QuestionType.GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT, DifficultyLevel.LEVEL5, questionTemplate));
        ...
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(18, QuestionType.GRE_READING_COMPREHENSION_SHORT, DifficultyLevel.LEVEL5, questionTemplate));
        questionTemplate = questionTemplateRepository.findByLabel("GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT-HARD-1L5");
        sectionTemplate.getSectionTemplateItems().add(new SectionTemplateItem(20, QuestionType.GRE_READING_COMPREHENSION_PARAGRAPH_ARGUMENT, DifficultyLevel.LEVEL5, questionTemplate));
        repository.save(sectionTemplate);
    }
